...
from rlcard.games.uno_new import Game
from rlcard.games.uno_new.utils import encode_hand, encode_target
from rlcard.games.uno_new.utils import ACTION_SPACE, ACTION_LIST
from rlcard.games.uno_new.utils import cards2list
...
class UnoEnv(Env):
    ...
    def __init__(self, config):
        ...
        self.state_shape = [[4, 4, 16] for _ in range(self.num_players)]
